  ...
  <d-navbar-nav class="border-left flex-row">
    ...
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle text-nowrap px-3" v-d-toggle.user-actions>
        <img class="user-avatar rounded-circle mr-2" src="@/assets/images/avatars/vaibhav.jpg" alt="User Avatar"> <span class="d-none d-md-inline-block">Vaibhav</span>
      </a>
    ...
    <div class="navbar__coins">
        <h6>Coins</h6>
        <h6 class="material-icons ml-3">sports_volleyball</h6>
        <h6 class="text-blue">{{ coins }}</h6>
    </div>
  </d-navbar-nav>
</template>
